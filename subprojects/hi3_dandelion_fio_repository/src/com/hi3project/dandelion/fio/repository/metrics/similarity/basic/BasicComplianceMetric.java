 ...
 *      03-nov-2014
 */
public class BasicComplianceMetric extends AbstractFIOAdequatenessMetric
{
    
    private final BasicInteractionComplianceMetric interactionMetric;
    private final BasicModalityComplianceMetric modalityMetric;
    private final BasicPhysicalComplianceMetric physicalMetric;
    private final BasicUsageComplianceMetric usageMetric;

    
    
    public BasicComplianceMetric(
            BasicInteractionComplianceMetric interactionMetric, 
            BasicModalityComplianceMetric modalityMetric, 
            BasicPhysicalComplianceMetric physicalMetric, 
            BasicUsageComplianceMetric usageMetric, 
            String id)
    {
        super(id);
    ...
    public FIOAdequateness calcAdequateness(FIOSpecification fioSpecs, FIODescription fioDesc)
    {
        ...
        PhysicalSimilarity physicalDistance = 
                this.physicalMetric.calcSimilarity(fioSpecs.getPhysicalSpecification(), fioDesc);
    ...
    {
        return this.physicalMetric.calcSimilarity(physicalSpecs, fioDesc);
    }
