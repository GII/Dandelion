 ...
 ******************************************************************************/
 ...
 package com.hi3project.dandelion.uib.modality.selector;
 ...
 *      24-jul-2014
 */
public interface IModalitySelector
{
    
    public Collection<Modality> selectModalities(
    ...
    public Collection<Modality> selectModalities(
            AbstractInteractionUnit aiu, EnvironmentProfile env);
    
    
    public Collection<Modality> selectModalities(
            AbstractInteractionUnit aiu, SceneProfile scene, UserProfile user, EnvironmentProfile env);
