 ...
 *      26-feb-2015
 */
public class FinalInteractionFacetMapping
{
    
    private AbstractInteractionUnit aiu;
    private InteractionSupportElement interactionFacet;
    private FIORepositoryEntryCompliance fioEntry;

    
    
    public FinalInteractionFacetMapping(
            AbstractInteractionUnit aiu, 
            InteractionSupportElement interactionFacet, 
            FIORepositoryEntryCompliance fioEntry)
    {
        this.aiu = aiu;
        this.interactionFacet = interactionFacet;
        this.fioEntry = fioEntry;
    }
    ...
    public InteractionSupportElement getInteractionFacet()
    {
        return interactionFacet;
    }

    public FIORepositoryEntryCompliance getFioEntry()
    {
        return fioEntry;
    }
