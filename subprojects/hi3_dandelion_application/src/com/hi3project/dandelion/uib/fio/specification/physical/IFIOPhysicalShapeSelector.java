 ...
 *      29-jul-2014
 */
public interface IFIOPhysicalShapeSelector 
{
    
    
    public Set<PhysicalShape> selectPhysicalShape(
            AbstractInteractionUnit aiu, Collection<Modality> modality, UserProfile user,
            double size, double status, double distance);
    
    
    public Set<PhysicalShape> selectPhysicalShape(
            AbstractInteractionUnit aiu, Collection<Modality> modality, EnvironmentProfile env,
            double size, double status, double distance);
    
    
    public Set<PhysicalShape> selectPhysicalShape(
            AbstractInteractionUnit aiu, Collection<Modality> modality, UserProfile user, EnvironmentProfile env,
            double size, double status, double distance);
