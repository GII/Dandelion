...
/** Public interface of the Dandelion Application Manager for only one application
 *
 ...
 *      17-nov-2014
 */
public interface IUserInterfaceManagerClient 
{
    
    
    public IUserInterfaceControllerPublicAPI getUserInterfaceController()
    ...
    public void changeContex(String user, String environment, String scene)
            throws InternalErrorException;
