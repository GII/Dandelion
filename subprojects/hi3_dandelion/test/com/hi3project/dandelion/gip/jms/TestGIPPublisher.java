 ...
 * @author gervasio
 */
public class TestGIPPublisher {
    
    
    
    
    public TestGIPPublisher() {
    }
    ...
    public void testPublishReceive() 
    {
        ...
        try {
            ...
            IGIPEventPublisher publisher = gipManager.startGIPPublisher("FIO1", "FIO-1", true);
            ...
            Logger.getLogger(TestGIPPublisher.class.getName()).log(Level.SEVERE, null, ex);
