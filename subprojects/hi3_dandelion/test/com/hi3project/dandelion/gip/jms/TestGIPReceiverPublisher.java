 ...
 * @author gervasio
 */
public class TestGIPReceiverPublisher {
    
    
    
    
    public TestGIPReceiverPublisher() {
    }
    ...
    public void testPublishReceive() 
    {
        ...
        try {
            ...
            gipManager.startGIPReceiver("FIO1-channel", true,
            ...
            IGIPEventPublisher publisher = gipManager.startGIPPublisher("FIO1","FIO1-channel", true);
            
            Thread.sleep(5000);
            
            publisher.input("1", new ArrayList<Property>(), new ArrayList<FuzzyVariable>());
            
            publisher.output("output1", new ArrayList<Property>(), new ArrayList<FuzzyVariable>());
            ...
            Logger.getLogger(TestGIPReceiverPublisher.class.getName()).log(Level.SEVERE, null, ex);
