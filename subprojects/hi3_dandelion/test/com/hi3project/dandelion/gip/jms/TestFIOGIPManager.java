 ...
 * @author gervasio
 */
public class TestFIOGIPManager {
    
    
    
    
    public TestFIOGIPManager() {
    }
    ...
    public void testPublishReceive() 
    {
        ...
        try {
            ...
            FIOMetadata fio = new FIOMetadata("FIO-1");
            FIOGIPManager fioGipManager = new FIOGIPManager(fio, gipManager);
            ...
            Logger.getLogger(TestFIOGIPManager.class.getName()).log(Level.SEVERE, null, ex);
