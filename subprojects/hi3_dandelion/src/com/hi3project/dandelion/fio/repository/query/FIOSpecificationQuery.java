 ...
 *      29-jul-2014
 */
public class FIOSpecificationQuery extends FIOQuery
{

    private final FIOSpecification fioSpec;
    
    
    public FIOSpecificationQuery(
            ...
            UsageSpecification usageSpecification)
    {
        ...
        this.fioSpec = new FIOSpecification(
                interactionSpecification, modalitySpecification, 
                physicalSpecification, usageSpecification);
        
    }

    
    
    public FIOSpecification getFioSpecification()
    {
        return fioSpec;
    }
