 ...
 *      16-abr-2014
 */
public class RegisterFIOAction extends FIORepositoryMessage 
{

    private final FIOExtendedMetadata fioMetadata;

    public RegisterFIOAction(long sequenceNumber, FIOExtendedMetadata fioMetadata, String clientId, String fioRepoId)
    {
        super(sequenceNumber, FIORepositoryMessageType.RegisterFIOAction, clientId, fioRepoId);
