 ...
 *      16-abr-2014
 */
public class FindFIOByIdAction extends FIORepositoryMessage
{
    
    private final String fioID;

    
    public FindFIOByIdAction(long sequenceNumber, String fioID, String clientId, String fioRepoId)
    {
        super(sequenceNumber, FIORepositoryMessageType.FindFIOByIdAction, clientId, fioRepoId);
        this.fioID = fioID;
    }
